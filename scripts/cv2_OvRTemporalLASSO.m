function [OvRmod_final, params] = cv2_OvRTemporalLASSO(Xs_trSet, Ys_trSet, ...
    ...
    for rho = 1:mRho
        ...
        for fold = 1:cv_fold
            ...
            OvRMod = OvRTrain_TemporalLASSO(cv_Xtr, cv_Ytr, Rhos(rho, :), opts);
    ...
    OvRMod = OvRTrain_TemporalLASSO(cv_Xtr, cv_Ytr, Rhos(I, :), opts);
    params.Rho1 = Rhos(I, 1);
    params.Rho2 = Rhos(I, 2);
    params.Rho3 = Rhos(I, 3);
