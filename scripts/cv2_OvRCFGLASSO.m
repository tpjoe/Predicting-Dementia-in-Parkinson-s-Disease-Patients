function [OvRmod_final, params] = cv2_OvRCFGLASSO(Xs_trSet, Ys_trSet, ...
    ...
    for rho = 1:mRho
        ...
        for fold = 1:cv_fold
            ...
            OvRMod = OvRTrain_CFGLASSO(cv_Xtr, cv_Ytr, Rhos(rho, :), opts);
    ...
    OvRMod = OvRTrain_CFGLASSO(cv_Xtr, cv_Ytr, Rhos(I, :), opts);
